...
folium.Marker([-6.8451028, 107.9249476], popup='<i>BANK SUMEDANG</i>').add_to(maps)
...
folium.Marker([-6.8453361, 107.9247266], popup='<i>Mebel Monalisa</i>').add_to(maps)

folium.Marker([-6.8449819, 107.9243184], popup='<i>PGAK</i>').add_to(maps)
